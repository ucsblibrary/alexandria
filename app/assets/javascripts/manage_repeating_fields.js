...
//
// This was ported from hydra-editor version 1.2.0

var AlexandriaEditor = (function($) {
...
(function($){
    $.fn.manage_fields = function(option) {
        return this.each(function() {
            ...
            if (!data) $this.data('manage_fields', (data = new AlexandriaEditor.FieldManager(this, options)));
        })
    }
})(jQuery);
