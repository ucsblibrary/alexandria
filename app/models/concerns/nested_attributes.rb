...
# accepts_nested_attributes_for can not be called until all the
# properties are declared because it calls resource_class, which
# finalizes the propery declarations.
#
...
module NestedAttributes
  ...
  included do
    ...
    accepts_nested_attributes_for :lc_subject,
                                  reject_if: id_blank,
                                  allow_destroy: true

    accepts_nested_attributes_for :form_of_work,
                                  reject_if: id_blank,
                                  allow_destroy: true

    accepts_nested_attributes_for :copyright_status,
                                  reject_if: id_blank,
                                  allow_destroy: true
    ...
    accepts_nested_attributes_for :rights_holder,
                                  reject_if: id_blank,
                                  allow_destroy: true
    ...
    accepts_nested_attributes_for :work_type,
                                  reject_if: id_blank,
                                  allow_destroy: true
    ...
    accepts_nested_attributes_for :date_other,
                                  reject_if: :time_span_blank,
                                  allow_destroy: true

    accepts_nested_attributes_for :date_valid,
                                  reject_if: :time_span_blank,
                                  allow_destroy: true
