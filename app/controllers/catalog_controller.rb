class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_facet_field ContributorIndexer::FACETABLE_CONTRIB, label: 'Contributor', limit: true
    ...
    config.add_facet_field solr_name('license', :facetable), label: 'License', limit: true
    ...
    config.add_index_field ContributorIndexer::CONTRIB_LABEL, label: 'Contributors'
