...
describe Qa::TermsController do
  ...
  describe "sub_location vocabulary" do
    it "returns terms" do
      get :search, params: { vocab: "local", subauthority: "sub_location", q: "ND" }
      expect(response).to be_success
    end
  end
  ...
  describe "work_type vocabulary" do
    it "returns terms" do
      get :search, params: { vocab: "local", subauthority: "work_type", q: "image" }
      expect(response).to be_success
  ...
  describe "local names" do
    ...
    it "returns terms" do
      get :search, params: { vocab: "local", subauthority: "names", q: "Baggins" }
      expect(response).to be_success
  ...
  describe "local subjects" do
    ...
    it "returns (topic) Frodo but not (person) Bilbo" do
      get :search, params: { vocab: "local", subauthority: "subjects", q: "Baggins" }
      expect(response).to be_success
