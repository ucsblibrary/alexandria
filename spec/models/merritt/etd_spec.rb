...
describe Merritt::Etd do
  ...
  let(:sys_ark) { "/d/ark%253A%252F13030%252Fm5zd31s2/2/producer%252/FBarel_ucsb_0035D_67%252" }
  ...
  let(:zip_file) { "#{sys_ark}FSmall%2520Town.zip" }
  let(:wav_file) { "#{sys_ark}FOri%2520Barel-Death%2520of%2520a%2520Moon.wav" }
