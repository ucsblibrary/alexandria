  ...
  context "with a file_set" do
    ...
    it "has images" do
      VCR.use_cassette("image_indexer") do
        ...
        expect(subject["image_url_ssm"]).to eq ["http://test.host/images/s1%2F78%2F4k%2F72%2Fs1784k724%2Ffiles%2F6185235a-79b2-4c29-8c24-4d6ad9b11470/full/400,/0/default.jpg"]
