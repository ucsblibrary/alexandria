...
describe ComponentMapIndexer do
  ...
  context "with a file_set" do
    ...
    it "has images" do
      VCR.use_cassette("component_map_indexer") do
        expect(subject["square_thumbnail_url_ssm"]).to eq ["/images/s1%2F78%2F4k%2F72%2Fs1784k724%2Ffiles%2F6185235a-79b2-4c29-8c24-4d6ad9b11470/full/75,75/0/default.jpg"]
        expect(subject["thumbnail_url_ssm"]).to eq ["/images/s1%2F78%2F4k%2F72%2Fs1784k724%2Ffiles%2F6185235a-79b2-4c29-8c24-4d6ad9b11470/full/300,/0/default.jpg"]
        expect(subject["image_url_ssm"]).to eq ["/images/s1%2F78%2F4k%2F72%2Fs1784k724%2Ffiles%2F6185235a-79b2-4c29-8c24-4d6ad9b11470/full/400,/0/default.jpg"]
        expect(subject["large_image_url_ssm"]).to eq ["/images/s1%2F78%2F4k%2F72%2Fs1784k724%2Ffiles%2F6185235a-79b2-4c29-8c24-4d6ad9b11470/full/1000,/0/default.jpg"]
      end
    end
  end
  ...
  describe "Indexing dates" do
    context "with an issued date" do
      let(:component_map) { ComponentMap.new(issued_attributes: [{ start: ["1902"] }]) }
    ...
    context "with issued.start and issued.finish" do
      ...
      let(:issued_end) { ["1923"] }
      let(:component_map) { ComponentMap.new(issued_attributes: [{ start: issued_start, finish: issued_end }]) }
  ...
  context "with local and LOC rights holders" do
    ...
    let(:component_map) { ComponentMap.new(rights_holder: [valerie_uri, regents_uri]) }
