...
describe IndexMapIndexer do
  ...
  describe "Indexing dates" do
    ...
    context "with an copyrighted date" do
      ...
      let(:index_map) { IndexMap.new(date_copyrighted_attributes: [{ start: copyrighted }]) }
    ...
    context "with issued.start and issued.finish" do
      ...
      let(:issued_end) { ["1923"] }
      let(:index_map) { IndexMap.new(issued_attributes: [{ start: issued_start, finish: issued_end }]) }
