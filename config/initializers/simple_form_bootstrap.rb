...
SimpleForm.setup do |config|
  ...
  # Wrappers for forms and inputs using the Bootstrap toolkit.  Check
  # the Bootstrap docs (http://getbootstrap.com) to learn about the
  # different styles for forms and inputs, buttons and other elements.
